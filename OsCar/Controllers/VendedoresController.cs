...
namespace OsCar.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(OsCarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedor != null ? 
                          ...
                          Problem("Entity set 'OsCarContext.Vendedor'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OsCarContext.Vendedor'  is null.");
            }
            var vendedor = await _context.Vendedor.FindAsync(id);
            if (vendedor != null)
            {
